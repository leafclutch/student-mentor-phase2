                  ...
                  <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-600 leading-relaxed mb-6">
                        Create a standard HTML5 boilerplate. Include a header, a
                        main content area with two sections, and a footer. Use
                        semantic tags correctly. Ensure your document passes the
                      ...
                      <div className="border-t border-gray-200 pt-6">
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                          * Ensure the repository is public before submitting.
                        </p>
                      </div>
                    </div>
                  </div>
